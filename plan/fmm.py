...
class FMMPlanner():
    def __init__(self, traversible, scale=1, step_size=5, add_obstacle_dist=True, obstacle_dist_cap=10, obstacle_dist_ratio=1.):
        self.scale = scale
    ...
    def get_short_term_goal(self, state):
        ...
        return (stg_y + state[0] - self.du) * scale, \
               (stg_x + state[1] - self.du) * scale, replan, stop
